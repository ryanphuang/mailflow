...
PLIST = {
    ...
    'CFBundleVersion'          : '1.0',
    'NSHumanReadableCopyright' :  'Copyright (C) 2016 Chris Webb <chris@arachsys.com>',
...
setup(
    ...
    options = dict(py2app = dict(
        ...
        includes        = ['appdirs', 'packaging', 'packaging.version', 'packaging.specifiers', 'packaging.requirements'],
